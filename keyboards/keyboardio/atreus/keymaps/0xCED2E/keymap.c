...
const uint16_t PROGMEM cmb_prn_opn[]     = {KC_LSFT, KC_D,    COMBO_END};  /* shift-d ∷ ( */
const uint16_t PROGMEM cmb_prn_clo[]     = {KC_SPC,  KC_K,    COMBO_END};  /* space-k ∷ ) */
const uint16_t PROGMEM cmb_brk_sqr_opn[] = {KC_LSFT, KC_C,    COMBO_END};  /* shift-c ∷ [ */
const uint16_t PROGMEM cmb_brk_sqr_clo[] = {KC_SPC,  KC_COMM, COMBO_END};  /* space-, ∷ ] */
...
const uint16_t PROGMEM cmb_grave[]       = {KC_LSFT, KC_W,    COMBO_END};  /* shift-w ∷ ` */
const uint16_t PROGMEM cmb_pipe[]        = {KC_SPC,  KC_O,    COMBO_END};  /* space-o ∷ | */
const uint16_t PROGMEM cmb_bslash[]      = {KC_SPC,  KC_P,    COMBO_END};  /* space-p ∷ \ */
