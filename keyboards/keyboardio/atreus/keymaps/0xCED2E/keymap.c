...
const uint16_t PROGMEM combo_parens_open[]   = {KC_C,    KC_V,    COMBO_END};  /* cv ∷ ( */
const uint16_t PROGMEM combo_parens_close[]  = {KC_M,    KC_COMM, COMBO_END};  /* m, ∷ ) */
const uint16_t PROGMEM combo_bracket_open[]  = {KC_X,    KC_C,    COMBO_END};  /* xc ∷ [ */
const uint16_t PROGMEM combo_bracket_close[] = {KC_COMM, KC_DOT,  COMBO_END};  /* ,. ∷ ] */
const uint16_t PROGMEM combo_brace_open[]    = {KC_Z,    KC_V,    COMBO_END};  /* xv ∷ { */
const uint16_t PROGMEM combo_brace_close[]   = {KC_M,    KC_SLSH, COMBO_END};  /* m/ ∷ } */
const uint16_t PROGMEM combo_brocket_open[]  = {KC_X,    KC_V,    COMBO_END};  /* xv ∷ < */
const uint16_t PROGMEM combo_brocket_close[] = {KC_M,    KC_DOT,  COMBO_END};  /* m. ∷ > */

const uint16_t PROGMEM combo_backtick[]      = {KC_K,    KC_SCLN, COMBO_END};  /* k; ∷ ` */
const uint16_t PROGMEM combo_single_quote[]  = {KC_L,    KC_SCLN, COMBO_END};  /* l; ∷ ' */
const uint16_t PROGMEM combo_double_quote[]  = {KC_J,    KC_SCLN, COMBO_END};  /* j; ∷ " */
const uint16_t PROGMEM combo_backslash[]     = {KC_M,    KC_SCLN, COMBO_END};  /* m; ∷ \ */
const uint16_t PROGMEM combo_pipe[]          = {KC_J,    KC_P,    COMBO_END};  /* jp ∷ | */
const uint16_t PROGMEM combo_underscore[]    = {KC_M,    KC_COMM, KC_DOT,  COMBO_END};  /* m,. ∷ _ */
const uint16_t PROGMEM combo_plus[]          = {KC_MINS, KC_EQL,  COMBO_END};  /* -= ∷ + */

const uint16_t PROGMEM combo_layer_num_lhs[] = {KC_D,    KC_F,    COMBO_END};  /* df ∷ NUM  */
const uint16_t PROGMEM combo_layer_sym_rhs[] = {KC_J,    KC_K,    COMBO_END};  /* jk ∷ SYM  */
...
combo_t key_combos[] = {
  ...
  COMBO(combo_parens_open,   KC_LPRN),
  COMBO(combo_parens_close,  KC_RPRN),
  ...
  COMBO(combo_brocket_open,  KC_LABK),
  COMBO(combo_brocket_close, KC_RABK),
  ...
  COMBO(combo_layer_sym_rhs, MO(_SYM_LHS)),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM_LHS] = LAYOUT(  /* [> LHS SYMBOL LAYER <] */
    KC_QUOT,KC_LT  ,KC_GT  ,KC_DQUO,KC_AMPR,                XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
    KC_EXLM,KC_MINS,KC_PLUS,KC_EQL ,KC_HASH,                XXXXXXX,XXXXXXX,XXXXXXX,TAB_NXT,TAB_PRV,
    KC_TILD,KC_SLSH,KC_ASTR,KC_BSLS,KC_PERC,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
    TO(0)  ,XXXXXXX,XXXXXXX,KC_LCMD,KC_LSFT,KC_LCTL,XXXXXXX,TAB_NXT,TAB_PRV,XXXXXXX,XXXXXXX,XXXXXXX
  ),
  [_SYM_RHS] = LAYOUT(  /* [> RHS SYMBOL LAYER <] */
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,                _______,_______,_______,_______,_______,
    TAB_PRV,TAB_NXT,XXXXXXX,XXXXXXX,XXXXXXX,                _______,_______,_______,_______,_______,
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_DEL ,_______,_______,_______,_______,_______,
    TO(0)  ,XXXXXXX,XXXXXXX,TAB_PRV,TAB_NXT,XXXXXXX,KC_RCTL,KC_RSFT,KC_SPC ,_______,_______,QK_LLCK
  ),
